...
public class ExtendedXSSFSheetXMLHandler extends DefaultHandler {
    ...
    private void outputCell() {
        ...
        // Output
        output.cell(cellRef, thisStr, value.toString(), this.cellType, this.formatString, comment);
    }
    ...
    private void checkForEmptyCellComments(ExtendedXSSFSheetXMLHandler.EmptyCellCommentsCheckType type) {
        if (commentCellRefs != null && !commentCellRefs.isEmpty()) {
            ...
            do {
                ...
                if (type == ExtendedXSSFSheetXMLHandler.EmptyCellCommentsCheckType.CELL && cellRef.equals(peekCellRef)) {
    ...
    private void outputEmptyCellComment(CellAddress cellRef) {
        ...
        output.cell(cellRef.formatAsString(), null, null, CellType.BLANK, null, comment);
    }
    ...
    public interface SheetContentsHandler {
         ...
         */
        void cell(String cellReference, String formattedValue, String rawValue, CellType cellType, String formatString, XSSFComment comment);
