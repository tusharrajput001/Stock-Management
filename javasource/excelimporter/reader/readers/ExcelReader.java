...
public class ExcelReader {
    ...
    public static final ILogNode logNode = Core.getLogger("ExcelXLSReader");
        ...
        if ((templateObject != null) && (context != null)) {
            ...
            try {
                ...
                switch (extension) {
                    ...
                    case XLSM:
                    case XLSX:
                        return ExcelXLSXDataReader.readHeaderRow(excelFile, sheetIndex, rowIndex);
                    case UNKNOWN:
    ...
    public long importData(IContext context, IMendixObject fileDocument, IMendixObject templateObject, IMendixObject parentObject)
        ...
        try {
            ...
            final var xpath = String.format("count(//%s[%s = %d])", Column.entityName, Column.MemberNames.Column_Template, templateObject.getId().toLong());
            logNode.debug(xpath);
